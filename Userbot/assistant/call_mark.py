...
`<code>kata kode</code>`: Tanda kutip terbalik digunakan buat font monospace. Ditampilkan sebagai: `kata kode`.
 ...
 `Halo Disini [Tombol 1|t.me/moire_room][Tombol 2|t.me/moire_logs|same]` : Ini akan membuat tombol berdampingan.

 Anda juga bisa membuat tombol callback_data dengan diawal tanda `#`. Untuk lebih lanjut silahkan ke @moire_logs untuk meminta bantuan.
"""
