...
async def spotify_search(client, message, *args):
    ...
    search_url = f"https://api.botcahx.eu.org/api/search/spotify?query={query}&apikey={botcax_api}"
    ...
    download_url = f"https://api.botcahx.eu.org/api/download/spotify?url={track_url}&apikey={botcax_api}"
