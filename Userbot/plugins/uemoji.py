...
@zb.ubot("emoid")
async def extract_emoji(client, message, _):
    try:
        if not message.reply_to_message:
            return await message.reply_text("<emoji id=4918014360267260850>⛔️</emoji> Please reply to a message to extract custom emoji IDs.")
        ...
        await message.reply_text(f"Emoji ID : {formatted_emojis}", parse_mode=ParseMode.DISABLED)
