...
async def random_bokep(client, message, *args):
    try:
        ...
        api_url = f"https://api.botcahx.eu.org/api/search/xnxx?query={search_query}&apikey={botcax_api}"
...
"""
        ...
        dl_url = f"https://api.botcahx.eu.org/api/download/xnxxdl?url={data['link']}&apikey={botcax_api}"
