...
class DatabaseClient:
    ...
    # Tambahkan di bawah fungsi lain di DatabaseClient:
    def set_quotly_setting(self, user_id: int, font: str = None, warna: str = None):
        # Ambil setting lama
        existing = self.get_var(user_id, "quotly_setting", query="vars") or {}
        if font:
            existing["font"] = font
        if warna:
            existing["warna"] = warna
        self.set_var(user_id, "quotly_setting", existing, query="vars")

    def get_quotly_setting(self, user_id: int):
        return self.get_var(user_id, "quotly_setting", query="vars") or {}
